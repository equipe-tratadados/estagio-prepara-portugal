...
> ### Tabela de Exemplo:
>
> | Ficheiro                          | Fonte                                        | URL                         | Data de coleta | Período dos dados | Transformações aplicadas                                                                                                                                               | Limitações conhecidas                                               | Responsável          |
> | :-------------------------------- | :------------------------------------------- | :-------------------------- | :------------- | :---------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------- | :------------------- |
> | residents_by_nationality_2024.csv | AIMA, Relatório de Imigração e Asilo 2024   | https://www.aima.gov.pt/... | 2026-05-26     | 2015 a 2024        | - Removidas linhas de totais e subtotais<br>- Coluna "País de origem" renomeada para "nationality"<br>- Valores monetários convertidos de milhares para euros (×1000) | Dados de 2024 são preliminares (publicação definitiva em set/2026)   | [nome do estagiário] |
